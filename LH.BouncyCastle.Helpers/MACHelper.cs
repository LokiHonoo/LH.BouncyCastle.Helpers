...
namespace LH.BouncyCastle.Helpers
{
    ...
    public static class MACHelper
    {
        ...
        /// <summary>
        /// Hash size 256 bits. Legal key size 256, 512 bits.
        /// </summary>
        public static IMAC DSTU7624_256_MAC { get; } = new MAC(SymmetricAlgorithmHelper.DSTU7624_256);

        /// <summary>
        /// Hash size 512 bits. Legal key size 512 bits.
        /// </summary>
        ...
        {
            return TryGetAlgorithm(mechanism, int.MinValue, out algorithm);
        }
        ...
        /// </summary>
        /// <param name="mechanism">Algorithm mechanism.</param>
        /// <param name="macSize">Legal mac size is between 8 and block size (8 bits increments).</param>
        /// <param name="algorithm">Algorithm.</param>
        /// <returns></returns>
